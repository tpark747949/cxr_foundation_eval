...
class _Split(Enum):
    ...
    def length(self) -> int:
        split_lengths = {
            _Split.TRAIN: 1_136_268, # 1_095_361, # 99_891, # modify this number
...
class CXRDatabase222(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "CXRDatabase222.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == CXRDatabase222.Split.TEST:
            dataset = None
