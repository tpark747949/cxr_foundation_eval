...
class _Split(Enum):
    ...
    def length(self) -> int:
        split_lengths = {
            _Split.TRAIN: 1_027_875, # 1_095_361, # 99_891, # modify this number
            _Split.VAL: 1, # modify this number
            _Split.TEST: 0,
        }
    ...
    def get_image_relpath(self, actual_index: int, class_id: Optional[str] = None) -> str:
        ...
        basename = f"{class_id}_{actual_index:06d}"
...
class CXRDatabasePLCO(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "CXRDatabasePLCO.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == CXRDatabase.Split.TEST:
            dataset = None
