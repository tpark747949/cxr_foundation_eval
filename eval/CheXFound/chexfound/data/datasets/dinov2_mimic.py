...
class _Split(Enum):
    ...
    def length(self) -> int:
        split_lengths = {
            _Split.TRAIN: 371_951, # 1_095_361, # 99_891, # modify this number
...
class DINOMimic(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "DINOMimic.Split":
        return self._split
