...
class _Split(Enum):
    ...
    def length(self) -> int:
        split_lengths = {
            _Split.TRAIN: 875_233, # 1_095_361, # 99_891, # modify this number
...
class CXRDatabase(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "CXRDatabase.Split":
        return self._split
