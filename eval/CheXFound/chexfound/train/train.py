...
def do_test(cfg, model, iteration):
    ...
    new_state_dict2 = model.state_dict()  # zy
    ...
    if distributed.is_main_process():
        ...
        model_ckp_path = os.path.join(eval_dir, "model_checkpoint.pth")  # zy
        torch.save({"model": new_state_dict2}, model_ckp_path)  # zy
...
def main(args):
    ...
    # Load pretrained weights before distributed training preparation
